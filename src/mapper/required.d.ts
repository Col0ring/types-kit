...
/**
  *
  * @description Make some properties in T required
  * @example
  * ```ts
  * interface Props {
      a?: number;
...
/**
  *
  * @description Make all properties (includes deep properties) in T required
  * @example
  * ```ts
  * interface Props {
      a?: {
...
/**
  * 
  * @description Make some properties (includes deep properties) in T required
  * @example
  * ```ts
  * interface Props {
       a?: {
